...
const Hero = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden pb-8 bg-background">
      <div className="container mx-auto px-4">
        <div className="relative h-[90vh] rounded-3xl overflow-hidden">
          {/* Background Carousel */}
          ...
          <div className="relative z-10 h-full flex items-center px-8 md:px-16">
            ...
            >
              ...
              >
                Ayudamos a empresas mineras a mantener sus operaciones en marcha.
              </motion.h1>
